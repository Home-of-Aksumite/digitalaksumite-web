          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                {/* Content */}
                <h3 className={cn('mb-3 text-xl font-semibold', 'text-[#0F2A44]', 'dark:text-white')}>
                  {service.title}
                </h3>
...
function ServerIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 01-2 2v4a2 2 0 012 2h14a2 2 0 012-2v-4a2 2 0 01-2-2m-2-4h.01M17 16h.01" />
    </svg>
  );
}
